...
| LuckPerms Forge bridge experiment | 5.4.46 | Forge / tested on 1.19.2 | 🔬 RESEARCH / POC | Original Forge artifact enables on Forge 43.5.0; H2, commands, real User, contexts, public API, permission transitions and clean shutdown proven | Feasibility only. No Atlas PermissionProvider, Bukkit service, virtual plugin, Vault integration or support status yet |
