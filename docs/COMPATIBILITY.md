...
| LuckPerms | 5.5.81 | Bukkit / tested on 1.19.2 | ⛔ BLOCKED | Official artifact discovery and structured first-failure diagnostic | Core permission injection assumes CraftBukkit and `SimplePluginManager` internals; not bundled |
